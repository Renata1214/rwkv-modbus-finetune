...
#     monitor="val_loss",       # name of the validation metric to monitor
...
#     )
    ...
    if pl.__version__[0]=='2':
        ...
        trainer = Trainer(
            ...
            precision=args.precision,
            logger=args.logger,
            callbacks=[train_callback(args), early_stop_callback],
            max_epochs=args.max_epochs,
    ...
    train_dataloader, val_dataloader = get_data_by_l_version(trainer=trainer, args=args)
